...
it("is an iterable with the exact sequence of values", () => {
  expect(array).toEqualSequence(1, 2, 3);
...
it("is an iterable that contains the exact sequence of values", () => {
  expect(array).toContainSequence(2, 3);
  expect(set).toContainSequence(2, 3);
});
`}
</TestFile>
...
it("is an iterable that contains the exact sequence of values", () => {
  expect(array).toContainEqualSequence(2, 3);
  expect(set).toContainEqualSequence(2, 3);
});
`}
</TestFile>
