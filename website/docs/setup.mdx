...
Mix 'n' Matchers is a set of custom Jest compatible matchers, aiming to fill perceived gaps in the Jest matcher ecosystem. This guide will help you get started.
...
<Tabs groupId="test-runner">
  ...
  <TabItem value="Rstest">
    ```ts title="test-setup.ts"

    import "mix-n-matchers/rstest";
